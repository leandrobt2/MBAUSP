...
# Manter apenas classes com pelo menos 2 registros
...
# Guardar nomes das colunas para interpretar coeficientes depois
...
# Classification report (já inclui macro e weighted averages)
report = classification_report(y_test, y_pred, digits=4)
print("\nClassification Report:\n", report)

# Se quiser acessar separadamente
